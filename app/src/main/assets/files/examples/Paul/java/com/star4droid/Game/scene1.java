...
public class scene1 extends StageImp {
    PlayerItem Box2,Box3,panel4,panel6,panel3,panel2,panel5,panel1,player,Box8,Box5,Box7,Box6,barrel,Box4,Progress1,coin2,coin3,coin1,Text1,edge;
    ...
    public void onCreate(){
		...
		BoxDef Box2_def = new BoxDef();
			...
			Box2_def.image="/primary:Cartoon_Forest_BG_01.png";
	...
	Box2 = (PlayerItem)(Box2_def.build(this));
		...
		BoxDef Box3_def = new BoxDef();
			...
			Box3_def.image="/primary:Cartoon_Forest_BG_01.png";
...
return;
			...
			@Override
			public void onTouchEnd(PlayerItem current, InputEvent event) {
player.getBody().applyLinearImpulse((float)(0),(float)(0),player.getBody().getWorldCenter().x,player.getBody().getWorldCenter().y, true);
