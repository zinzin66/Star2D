...
public class win extends StageImp {
    PlayerItem Box1,Box2,Box3,Text1,coin2,coin1,coin3;
    ...
    public void onCreate(){
		...
		BoxDef Box1_def = new BoxDef();
			...
			Box1_def.image="/primary:Cartoon_Forest_BG_01.png";
