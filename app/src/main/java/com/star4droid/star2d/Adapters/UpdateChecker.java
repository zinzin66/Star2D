...
public class UpdateChecker {
    ...
    private static final String CURRENT_VERSION = "0.1.6";
    private static final String CHECK_UPDATE_URL = "https://raw.githubusercontent.com/star4droid/Star2D/refs/heads/master/assets/latest.version"; // Replace with your URL
    ...
    public static void checkForUpdate(Context context) {
        ...
        executorService.execute(() -> {
            ...
            com.badlogic.gdx.Gdx.files.external("logs/update.txt").writeString("version : "+latestVersion+"\n",true);
            mainHandler.post(() -> {
    ...
    private static String fetchLatestVersion() {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                com.badlogic.gdx.Gdx.files.external("logs/update.txt").writeString("response not ok\n",true);
            }
            connection.disconnect();
        } catch (Exception e) {
            e.printStackTrace();
            com.badlogic.gdx.Gdx.files.external("logs/update.txt").writeString("Error : "+e.toString()+"\n",true);
