...
public class VisualNode extends VisWindow {
    ...
    public void drawConnectionLines(ShapeRenderer shapeRenderer) {
        ...
        if (trueNode != null && trueNode.getParent() == null) {
            trueNode = null;
        }
        if (falseNode != null && falseNode.getParent() == null) {
            falseNode = null;
        }
    ...
    public static class VirtualKeyboard extends VisTable {
        ...
        private void handleKeyPress(String key) {
            ...
            switch (key) {
                ...
                case "✓":
                    if (onConfirm != null) {
                        onConfirm.run(); // ✅ do same as Save button
    ...
    public static class NodeField extends VisTable {
        ...
        public VisTable contentWrapper;
        ...
        public NodeField(String name, String initialValue, UiStage stage) {
            ...
            contentWrapper.add(valueButton).size(120, 35);
            add(contentWrapper).expandX().right();
        ...
        public void setParameterBlock(String template, String displayTemplate) {
            if (parameterBlock != null) {
                parameterBlock.remove();
            }
            parameterBlock = new ParameterBlock(this, template, displayTemplate);

            contentWrapper.clearChildren();
            contentWrapper.add(parameterBlock).growX().right();

            if (getParentVisualNode() != null) {
                getParentVisualNode().pack();
            }
        }

        public void removeParameterBlock() {
            if (parameterBlock != null) {
                parameterBlock.remove();
                parameterBlock = null;
            }
        ...
        public String generateCode() {
            if (parameterBlock != null) {
                return parameterBlock.generateCode();
            }
            return value;
        }
